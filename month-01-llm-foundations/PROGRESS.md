...
> 以下保留作者的学习进度与历史验证记录，不代表公共课程的完成度或当前测试数量。
> 新读者请从[课程索引](./lessons/README.md)开始，使用[学习记录模板](../templates/learning-log.md)
> 在自己的 Fork 中记录进度。当前课程发布状态见[仓库首页](../README.md#课程状态)。
